...
const Footer: React.FC = () => {
    ...
    //             position: "absolute",
    //             ...styles1
    //         }} className="custom-shape-divider-top-1764066514">
    //             <svg className="bg-gradient-to-br from-[#A58FFF] via-[#3300FF] to-[#A58FFF]" style={{
    //                 position: "relative",
    //                 display: "block",
    ...
    //                 <path style={{
    //                     fill: "#FFFFFF"
    //                 }} d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" className="shape-fill"></path>
    //             </svg>
    //         </div>
            ...
            <div className="px-6 m-auto h-[100%] overfloe-hidden pt-4 bg-[radial-gradient(35%_63%_at_50%_50%,_rgb(99,102,241)_0%,_rgb(67,56,202)_100%)] rounded-t-[54.69px] border border-[rgba(255,255,255,0.04)] text-white">
                <div className="relative flex flex-col p-4 items-center xl:items-start gap-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 w-full lg:w-[50%] 3xl:w-[30%]">
                        <p className="text-3xl font-semibold">Edge<span className='bg-gradient-to-r from-slate-300 to-slate-500 bg-clip-text text-transparent'>Frame</span> Solutions</p>
