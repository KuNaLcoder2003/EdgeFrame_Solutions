...
const Hero: React.FC = () => {
    return (
        <div className="max-w-7xl mx-auto px-6 py-4 relative h-screen">
...
const HeroText = () => {
    return (
        <div className="flex flex-col items-baseline gap-8 w-full">
            ...
            <div className="w-[200px] flex items-start gap-2 inset-shadow-xs py-[0.8px] rounded-full">
            ...
            <div className="text-[60px] md:text-[72px] w-screen lg:w-[60%] leading-none font-[Inter] font-semibold">
                <p>
            ...
            <div className="font-light text-lg text-stone-500 w-[400px] lg:w-[500px]">
